...
logger = setup_logger("zendesk_ask_compute_bot.confluence_helper", constants.LOG_LEVEL)
...
def convert_summary_to_markdown(
    thread_summary: dict, messages: list, users: list, message_link: str
) -> str:
    """
